...
import org.fhcrc.honeycomb.metapop.mutation.MutateCoopToCheatAncToEvoDelay;
...
public abstract class AdaptiveRace {
    ...
    public void run() {
        ...
        double delay_hrs = 1000;
        mutation_rule = 
            new MutateCoopToCheatAncToEvoDelay(coop_to_cheat_mutation_rate,
