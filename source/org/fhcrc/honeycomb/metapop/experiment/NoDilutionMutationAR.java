...
/** 
 * A TestMutationAR with no dilution.
 ...
 *
 */
public class NoDilutionMutationAR extends MutationAR {
    public NoDilutionMutationAR(String args[]) { super(args); }
    ...
    public static void main(String args[]) {
        MutationAR ar = new NoDilutionMutationAR(args);
        ar.run();
    }
}
